...
function getConnection() {
	...
	global $db_webguru1_db_Url, $db_webguru1_db_User, $db_webguru1_db_Pass, $db_webguru1_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_webguru1_db_Url.";dbname=".$db_webguru1_db_DbName, $db_webguru1_db_User, $db_webguru1_db_Pass);
