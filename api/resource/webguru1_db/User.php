...
?>
<?php
	require_once './db/dbwebguru1_dbManager.php';
...
$app->post('/user',	function () use ($app){
	...
	$obj = makeQuery("INSERT INTO user (_id, mail, name, password, roles, username )  VALUES ( null, :mail, :name, :password, :roles, :username   )", $params, false);
...
$app->post('/user/:id',	function ($id) use ($app){
	...
	$obj = makeQuery("UPDATE user SET  mail = :mail,  name = :name,  password = :password,  roles = :roles,  username = :username   WHERE _id = :id LIMIT 1", $params, false);
